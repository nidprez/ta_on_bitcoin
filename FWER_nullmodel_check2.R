...
t_stat2 <- rbind(t_stat, 0)
b_stat2 <- rbind(b_stat, 0)



FWERkControl(t_stat2,b_stat2,1,0.05)
FDPControl(t_stat2,b_stat2,0.1,0.05)
t_stat2 <- rbind(t_stat2, 0)
b_stat2 <- rbind(b_stat2, 0)